...
set(CONAN_FRUIT_ROOT "/home/malte/.conan/data/fruit/3.2.0/inexorgame/stable/package/25e4462452b2782a168076cf14823c8bc43713fe")
set(CONAN_INCLUDE_DIRS_FRUIT "/home/malte/.conan/data/fruit/3.2.0/inexorgame/stable/package/25e4462452b2782a168076cf14823c8bc43713fe/include")
set(CONAN_LIB_DIRS_FRUIT "/home/malte/.conan/data/fruit/3.2.0/inexorgame/stable/package/25e4462452b2782a168076cf14823c8bc43713fe/lib")
set(CONAN_BIN_DIRS_FRUIT )
set(CONAN_RES_DIRS_FRUIT )
set(CONAN_BUILD_DIRS_FRUIT "/home/malte/.conan/data/fruit/3.2.0/inexorgame/stable/package/25e4462452b2782a168076cf14823c8bc43713fe/")
...
set(CONAN_SETTINGS_COMPILER_VERSION "5.4")
set(CONAN_SETTINGS_OS "Linux")

set(CONAN_DEPENDENCIES fruit)
...
set(CONAN_INCLUDE_DIRS "/home/malte/.conan/data/fruit/3.2.0/inexorgame/stable/package/25e4462452b2782a168076cf14823c8bc43713fe/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/home/malte/.conan/data/fruit/3.2.0/inexorgame/stable/package/25e4462452b2782a168076cf14823c8bc43713fe/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS  ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_LIBS fruit ${CONAN_LIBS})
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_CMAKE_MODULE_PATH "/home/malte/.conan/data/fruit/3.2.0/inexorgame/stable/package/25e4462452b2782a168076cf14823c8bc43713fe/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_FRUIT}" "${CONAN_LIB_DIRS_FRUIT}"
                                  CONAN_PACKAGE_TARGETS_FRUIT "" "" fruit)
    conan_package_library_targets("${CONAN_LIBS_FRUIT_DEBUG}" "${CONAN_LIB_DIRS_FRUIT_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_FRUIT_DEBUG "" "debug" fruit)
    conan_package_library_targets("${CONAN_LIBS_FRUIT_RELEASE}" "${CONAN_LIB_DIRS_FRUIT_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_FRUIT_RELEASE "" "release" fruit)

    add_library(CONAN_PKG::fruit INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::fruit PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_FRUIT} ${CONAN_SHARED_LINKER_FLAGS_FRUIT_LIST} ${CONAN_EXE_LINKER_FLAGS_FRUIT_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_FRUIT_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_FRUIT_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_FRUIT_RELEASE_LIST}>
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_FRUIT_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_FRUIT_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_FRUIT_RELEASE_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_FRUIT_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_FRUIT_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_FRUIT_RELEASE_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_FRUIT_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_FRUIT_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_FRUIT_DEBUG_LIST}>
                                                                 )
    ...
    set(CONAN_TARGETS CONAN_PKG::fruit)
